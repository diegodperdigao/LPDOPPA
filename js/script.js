...
(() => {
  ...
  // VTurb é o player padrão (ver bloco inline no index.html). O caminho do YouTube só roda
  // com ?player=youtube (rollback), pra não carregar os dois.
  if (new URLSearchParams(location.search).get("player") !== "youtube") return;
